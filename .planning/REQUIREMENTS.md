...
- [x] **REQ-CI-05**: Pluggable multi-source session harvest + cross-source/cross-repo ticket linking — unify OpenCode/Claude (and future agents) into one sessions collection, link by ticket/branch/parent (Phase 8 complete 2026-06-29)
