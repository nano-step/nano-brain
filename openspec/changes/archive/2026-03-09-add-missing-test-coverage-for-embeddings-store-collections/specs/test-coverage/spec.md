...
None — this change only adds new test files and test cases. No modifications to source code.

---

## Success Criteria

✅ test/embeddings.test.ts created with 50+ test cases covering:
  - Health check functions (4+ cases)
  - OllamaEmbeddingProvider class (8+ cases)
  - OpenAICompatibleEmbeddingProvider class (15+ cases)
  - createEmbeddingProvider factory (5+ cases)

✅ test/store.test.ts updated with 8+ test cases for sanitizeFTS5Query()

✅ test/collections.test.ts updated with 10+ test cases for helper functions

✅ All tests pass: `npm run test`

✅ Code coverage:
  - embeddings.ts: ≥ 90%
  - sanitizeFTS5Query: 100%
  - collections helpers: ≥ 85%
